...
-- 🎭 EMOTE TAB (or any other tab name)
local emoteTab = window:AddTab("Tags")

emoteTab:AddLabel("━━━━━━━ Here you can choose your TAG ━━━━━━━").TextSize = 17

-- 🌈 RAINBOW TAG - Boss Kenzou
local Players = game:GetService("Players")
local player = Players.LocalPlayer

local currentTagText = "Boss Kenzou

-- 🧠 Function to create or update the tag
local function createOrUpdateTag(char)
    task.wait(0.5)
    if not char:FindFirstChild("Head") then return end

    -- Delete previous tag if it already exists
...
-- 📦 Create tag when loading character
...
emoteTab:AddButton("🔥 FNOP", function()
    ...
    library:Notification("✅ Tag applied: 🔥FNOP🔥")
end)
...
emoteTab:AddButton("🔥 PrimeKenzou", function()
    ...
    currentTagColor = Color3.fromRGB(255, 70, 70)
    createOrUpdateTag(player.Character)
    library:Notification("✅ Tag applied: PrimeKenzou🔥")
end)

emoteTab:AddButton("👑 Pogi Ako", function()
    currentTagText = "Pogi Ako👑"
    currentTagColor = Color3.fromRGB(255, 255, 0)
    createOrUpdateTag(player.Character)
    library:Notification("✅ Tag applied: Pogi Ako👑")
end)
...
emoteTab:AddButton("⚡ ScriptDeveloper", function()
    ...
    createOrUpdateTag(player.Character)
    library:Notification("✅ Tag applied: ScriptDeveloper⚡")
end)

emoteTab:AddLabel("Remove The Tag If You Want").TextSize = 17

-- 🗑️ Optional button to remove the tag
emoteTab:AddButton("❌ Remove Tag", function()
    if player.Character and player.Character:FindFirstChild("Head") then
        local old = player.Character.Head:FindFirstChild("CustomTag")
        if old then
            old:Destroy()
            library:Notification("🧹 Tag deleted.")
        else
            library:Notification("⚠️ You don't have an active tag.")
        end
    end
end)
